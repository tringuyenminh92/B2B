...
{
    public class KhachhangDetailPresenter : Presenter<IKhachhangDetailView>
    {
        ...
        public KhachhangDetailPresenter(IKhachhangDetailView view)
            : base(view)
        { }
        ...
        public void DisplayNhomKhachhang()
        {
            try
            {
                View.NhomKhachhangItems = Model.Get<NhomKhachhangModel>("Tri_GetNhomKhachhangActive");
        ...
        public void DisplayQuanhuyenTheoTinhthanh()
        {
            try
            {
                var current = View.Value as KhachhangModel;
                if (current == null)
                {
                    return;
                }
                ...
                {
                    Name = "TinhthanhId",
                    Value = View.Value.TinhthanhId,
                    SqlType = System.Data.SqlDbType.UniqueIdentifier
                });
                View.QuanhuyenItems = Model.Get<QuanhuyenModel>(new AutoObject
                {
                    Items = items,
                    SpName = "Tri_GetQuanhuyenActiveTheoTinhthanh"
                });
                View.RefreshDataQuanhuyen();
            }
            catch (Exception ex)
