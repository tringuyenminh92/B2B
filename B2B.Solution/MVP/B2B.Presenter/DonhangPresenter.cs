...
namespace B2B.Presenter
{
    ...
    public class DonhangPresenter : Presenter<IDonhangView>
    {
        ...
        public bool DaHuy()
        {
            ...
            if (View.DonhangCurrent.TinhtrangDonhangCurrentId == TinhtrangHuys[0].TinhtrangId)
            {
                return true;
            }
            return false;
        ...
        public bool DaChot()
        {
            ...
            if (View.DonhangCurrent.TinhtrangDonhangCurrentId == TinhtrangChots[0].TinhtrangId)
            {
                return true;
            }
            return false;
