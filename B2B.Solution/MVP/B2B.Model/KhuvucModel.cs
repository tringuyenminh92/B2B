...
namespace B2B.Model
{
    public partial class KhuvucModel : Bus
    {
        private Guid _KhuvucId;
        ...
        {
			OnCreating();
            KhuvucId = ModelCore.GetGuidId();
			OnCreated();
        }

        public KhuvucModel(AutoObject value)
        {
			OnCreating();
        ...
        [DisplayName("TenKhuvuc")]
        public String TenKhuvuc
        {
            get
			{
				String vGet = _TenKhuvuc;
				OnTenKhuvucGetting(ref _TenKhuvuc, ref vGet);
				return vGet;
			}
            set
            {
                OnTenKhuvucChanging(value);
                SetProperty(ref _TenKhuvuc, value);
                OnTenKhuvucChanged();
            }
        }
        ...
        partial void OnKhuvucIdChanging(Guid value);
        partial void OnKhuvucIdChanged();
		partial void OnKhuvucIdGetting(ref Guid value, ref Guid vGet);
		...
		partial void OnTenKhuvucGetting(ref String value, ref String vGet);
        ...
        public override AutoObject DataToAutoObject()
        {
            ...
            Items.Add(new AutoItem {Name = "TenKhuvuc", Value = TenKhuvuc, SqlType = SqlDbType.NVarChar});
        ...
        public override string GetSpName()
        {
            if (State == RowState.Insert)
                return "sys_KhuvucInsert";
            if (State == RowState.Update)
                return "sys_KhuvucUpdate";
            if (State == RowState.Delete)
                return "sys_KhuvucDelete";
            return "sys_KhuvucSelect";
        }
    }
}