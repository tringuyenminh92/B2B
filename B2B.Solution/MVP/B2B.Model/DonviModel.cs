...
namespace B2B.Model
{
    public partial class DonviModel : Bus
    {
        ...
        {
			OnCreating();
            DonviId = ModelCore.GetGuidId();
			OnCreated();
        }

        public DonviModel(AutoObject value)
        {
			OnCreating();
        ...
        partial void OnDonviIdChanging(Guid value);
        partial void OnDonviIdChanged();
		partial void OnDonviIdGetting(ref Guid value, ref Guid vGet);
        ...
        public override AutoObject DataToAutoObject()
        {
            ...
            Items.Add(new AutoItem {Name = "TenDonvi", Value = TenDonvi, SqlType = SqlDbType.NVarChar});
        ...
        public override string GetSpName()
        {
            if (State == RowState.Insert)
                return "sys_DonviInsert";
            if (State == RowState.Update)
                return "sys_DonviUpdate";
            if (State == RowState.Delete)
                return "sys_DonviDelete";
            return "sys_DonviSelect";
        }
    }
}