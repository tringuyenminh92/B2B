...
namespace B2B.Model
{
    public partial class PhongbanModel : Bus
    {
        private Guid _PhongbanId;
        ...
        {
			OnCreating();
            PhongbanId = ModelCore.GetGuidId();
			OnCreated();
        }

        public PhongbanModel(AutoObject value)
        {
			OnCreating();
        ...
        [DisplayName("TenPhongban")]
        public String TenPhongban
        {
            get
			{
				String vGet = _TenPhongban;
				OnTenPhongbanGetting(ref _TenPhongban, ref vGet);
				return vGet;
			}
            set
            {
                OnTenPhongbanChanging(value);
                SetProperty(ref _TenPhongban, value);
        ...
        partial void OnPhongbanIdChanging(Guid value);
        partial void OnPhongbanIdChanged();
		partial void OnPhongbanIdGetting(ref Guid value, ref Guid vGet);
		...
		partial void OnTenPhongbanGetting(ref String value, ref String vGet);
        ...
        public override AutoObject DataToAutoObject()
        {
            ...
            Items.Add(new AutoItem {Name = "TenPhongban", Value = TenPhongban, SqlType = SqlDbType.NVarChar});
        ...
        public override string GetSpName()
        {
            if (State == RowState.Insert)
                return "sys_PhongbanInsert";
            if (State == RowState.Update)
                return "sys_PhongbanUpdate";
            if (State == RowState.Delete)
                return "sys_PhongbanDelete";
            return "sys_PhongbanSelect";
        }
    }
}